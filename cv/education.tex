  ...
  \cventry
    ...
    {Sep. 2025 - May 2026} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Currently in my first semester under the program EUMaster4HPC for a double degree.}
        \item {I will spend my first year on Université du Luxembourg, and the second year in Sofia University St. Kliment Ohridski.}
      \end{cvitems}
    }
